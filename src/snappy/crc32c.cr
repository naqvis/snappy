...
class Snappy::CRC32C
  ...
  def self.unmask(masked_crc)
    rot = masked_crc32c - MASK_DELTA
    (rot >> 17) | (rot << 15)
  end

  def initialize
    @crc = 0_u32 # current CRC value, bit-flipped
    reset
  end
